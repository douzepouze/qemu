...
static void test_nrf51_gpio(void)
{
    ...
    writel(GPIO_BASE + GPIO_CNF_START, 0x00);
    set_irq_in("/machine/nrf51", "unnamed-gpio-in", 0, 0);
    actual = readl(GPIO_BASE + GPIO_IN) & 0x01;
    g_assert_cmpuint(actual, ==, 0x00);
    ...
    actual = readl(GPIO_BASE + GPIO_IN) & 0x01;
    g_assert_cmpuint(actual, ==, 0x01);
    writel(GPIO_BASE + GPIO_CNF_START, 0x02);

    /* Check pull-up working */
    set_irq_in("/machine/nrf51", "unnamed-gpio-in", 0, 0);
    writel(GPIO_BASE + GPIO_CNF_START, 0b0000);
    actual = readl(GPIO_BASE + GPIO_IN) & 0x01;
    g_assert_cmpuint(actual, ==, 0x00);
    writel(GPIO_BASE + GPIO_CNF_START, 0b1110);
    actual = readl(GPIO_BASE + GPIO_IN) & 0x01;
    g_assert_cmpuint(actual, ==, 0x01);
    writel(GPIO_BASE + GPIO_CNF_START, 0x02);
    ...
    actual = readl(GPIO_BASE + GPIO_IN) & 0x01;
    g_assert_cmpuint(actual, ==, 0x01);
    writel(GPIO_BASE + GPIO_CNF_START, 0b0110);
    actual = readl(GPIO_BASE + GPIO_IN) & 0x01;
    g_assert_cmpuint(actual, ==, 0x00);
    writel(GPIO_BASE + GPIO_CNF_START, 0x02);
    set_irq_in("/machine/nrf51", "unnamed-gpio-in", 0, -1);
    ...
    writel(GPIO_BASE + GPIO_CNF_START, 0b0011);
    writel(GPIO_BASE + GPIO_OUTSET, 0x01);
    g_assert_true(get_irq(0));
    writel(GPIO_BASE + GPIO_OUTCLR, 0x01);
    g_assert_false(get_irq(0));

    /* Check self-stimulation */
    writel(GPIO_BASE + GPIO_CNF_START, 0b01);
    writel(GPIO_BASE + GPIO_OUTSET, 0x01);
    actual = readl(GPIO_BASE + GPIO_IN) & 0x01;
    g_assert_cmpuint(actual, ==, 0x01);
